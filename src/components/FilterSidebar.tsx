...
export default function FilterSidebar({ filters, onFilterChange, filterOptions, isOpen, onClose }: FilterSidebarProps) {
  ...
  return (
    <>
      ...
      <div className={`w-64 bg-gradient-to-b from-[#A53758] to-[#8B2F4A] text-white fixed left-0 top-16 overflow-y-auto shadow-xl z-50 transition-transform duration-300 lg:translate-x-0 ${
      ...
      <div className="p-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Date Range</label>
            <DateRangeSelector
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Search</label>
            <input
              type="text"
              placeholder="Search campaigns..."
              value={filters.search}
              onChange={(e) => updateFilter('search', e.target.value)}
              className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:ring-2 focus:ring-white focus:border-transparent text-sm"
            />
          </div>

          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Paid/Organic</label>
            <select
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Channel</label>
            <select
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Region</label>
            <select
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Call/Form</label>
            <select
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Bx Type</label>
            <select
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Centre Name</label>
            <select
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">RH</label>
            <select
              value={filters.rh}
          ...
          <div>
            <label className="block text-xs font-medium text-white/90 mb-2">Campaign</label>
            <select
        ...
        {activeFiltersCount > 0 && (
          <div className="mt-6 p-3 bg-white/10 rounded-lg border border-white/20">
            <div className="text-xs text-white/70 mb-1">Active Filters</div>
